# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 10:52:29 2024
...
def find_antinodes(grid):  
    ...
    for key in nodes.keys(): #Por cada clase de nodo
        ...
        for tupla in unique_permutations: #Por cada tupla
            ...
            #Se actualiza el grid comprobando los limites por cada asignacion
            if is_inbounds(antinodo1[0],antinodo1[1], antinode_grid):
                antinode_grid[antinodo1[1]][antinodo1[0]] = '#'
            if is_inbounds(antinodo2[0],antinodo2[1], antinode_grid):
